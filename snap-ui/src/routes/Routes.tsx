...
import BoslerUIComponents from "apps/developer/BoslerUIComponents";
...
import BoslerComponents from "apps/developer/BoslerComponents";
...
import BoslerHome from "apps/home/BoslerHome";
      ...
      <Route path="/" element={<AppContainer />}>
        <Route path="/" element={<PrivateOutlet />}>
          ...
          <Route path="/portal" element={<Home />}>
            <Route index element={<Navigate to="/portal/home" />} />
            <Route path="home" element={<BoslerHome />} />
          </Route>
          ...
          <Route path="/portal" element={<DeveloperHome />}>
            {process.env.NODE_ENV !== "production" && (
              <>
                ...
                <Route path="components" element={<BoslerComponents />} />
                <Route path="typography" element={<Typhography />} />
                <Route path="uicomponents" element={<BoslerUIComponents />} />
