import {
  ...
  IS_CONNECT_ADMIN_FAIL,
  IS_CONNECT_ADMIN_REQUEST,
...
export const loginMethod = (state = { method: "" }, action: $TSFixMe) => {
  switch (action.type) {
...
export const isUserAdminReducer = (state = {}, action: $TSFixMe) => {
  switch (action.type) {
...
export const isProjectAdminReducer = (state = {}, action: $TSFixMe) => {
  switch (action.type) {
...
export const isGroupAdminReducer = (state = {}, action: $TSFixMe) => {
  switch (action.type) {
...
export const isPlatformAdminReducer = (state = {}, action: $TSFixMe) => {
  switch (action.type) {
    case IS_PLATFORM_ADMIN_REQUEST:
      return { user: undefined, loading: true, error: false };

    case IS_PLATFORM_ADMIN_SUCCESS:
      return { user: action.payload, loading: false, error: false };

    case IS_PLATFORM_ADMIN_FAIL:
      return { user: undefined, loading: false, error: action.payload };
...
export const isConnectAdminReducer = (state = {}, action: $TSFixMe) => {
  switch (action.type) {
    case IS_CONNECT_ADMIN_REQUEST:
      return { user: undefined, loading: true, error: false };

    case IS_CONNECT_ADMIN_SUCCESS:
      return { user: action.payload, loading: false, error: false };

    case IS_CONNECT_ADMIN_FAIL:
      return { user: undefined, loading: false, error: action.payload };
