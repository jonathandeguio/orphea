package io.orphea.snap.comments.controllers;

//import io.orphea.snap.build.library.models.SocketMessage;

import io.orphea.snap.comments.library.models.CommentModel;
import io.orphea.snap.comments.library.models.CommentRequestModel;
import io.orphea.snap.comments.library.repository.CommentRepository;
import io.orphea.snap.comments.library.services.CommentService;
...
@Tag(name = "Comments", description = "This is a comments management service.")
