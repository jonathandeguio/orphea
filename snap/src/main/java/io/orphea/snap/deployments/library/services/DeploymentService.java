...
import io.orphea.snap.deployments.library.Enums.DeploymentMethod;
...
import io.orphea.snap.deployments.library.repository.ConfigurationComponentsRepository;
import io.orphea.snap.deployments.library.repository.DeploymentRepository;
import io.orphea.snap.deployments.library.requests.DeploymentStateRequestModel;
...
public class DeploymentService {
    ...
    private ConfigurationComponentsModel createNewConfigurationComponent(DeploymentModel deployment, DeploymentStateRequestModel requestModel, ConfigurationState configurationState, String globalVersion) {
        return ConfigurationComponentsModel.builder()
                ...
                .orpheaDocs(requestModel.getOrpheaDocs())
    ...
    public void updateAutomaticDeployments(String componentName, String newTag, String branch) throws Exception {
        ...
        for (DeploymentModel deployment : automaticDeployments) {
            ...
            requestModel.setOrpheaDocs(activeComponent.getOrpheaDocs());
            ...
            switch (componentName.toLowerCase()) {
                ...
                case "capture":
                    ...
                    break;
                case "orphea-docs":
                    requestModel.setOrpheaDocs(newTag);
                    break;
...
//            List<ConfigurationComponentsModel> activeModels = configurationComponentsRepository.findByStateAndFrontendAndBosonAndParlerAndJuliaAndCallistoAndCaptureAndOrpheaDocsAndSparkHistoryServerAndBranch(
...
//                    deploymentStateRequestModel.getOrpheaDocs(),
...
//            } else {
//                List<ConfigurationComponentsModel> targetModels = configurationComponentsRepository.findByStateAndFrontendAndBosonAndParlerAndJuliaAndCallistoAndCaptureAndOrpheaDocsAndSparkHistoryServerAndBranch(
