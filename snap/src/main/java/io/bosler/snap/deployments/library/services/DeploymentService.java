package io.bosler.snap.deployments.library.services;
...
import io.bosler.snap.deployments.library.requests.DeploymentStateRequestModel;
...
public class DeploymentService {
    ...
    private ConfigurationComponentsModel createNewConfigurationComponent(DeploymentModel deployment, DeploymentStateRequestModel requestModel, ConfigurationState configurationState, String globalVersion) {
        return ConfigurationComponentsModel.builder()
                ...
                .boslerDocs(requestModel.getBoslerDocs())
    ...
    public void updateAutomaticDeployments(String componentName, String newTag, String branch) throws Exception {
        ...
        for (DeploymentModel deployment : automaticDeployments) {
            ...
            requestModel.setBoslerDocs(activeComponent.getBoslerDocs());
            ...
            switch (componentName.toLowerCase()) {
                ...
                case "capture":
                    ...
                    break;
                case "bosler-docs":
                    requestModel.setBoslerDocs(newTag);
                    break;
...
//            List<ConfigurationComponentsModel> activeModels = configurationComponentsRepository.findByStateAndFrontendAndBosonAndParlerAndJuliaAndCallistoAndCaptureAndBoslerDocsAndSparkHistoryServerAndBranch(
...
//                    deploymentStateRequestModel.getBoslerDocs(),
...
//            } else {
//                List<ConfigurationComponentsModel> targetModels = configurationComponentsRepository.findByStateAndFrontendAndBosonAndParlerAndJuliaAndCallistoAndCaptureAndBoslerDocsAndSparkHistoryServerAndBranch(
