package io.bosler.snap.passport.security.oauth2;

import io.bosler.snap.passport.exception.OAuth2AuthenticationProcessingException;
...
import io.bosler.snap.passport.security.oauth2.user.OAuth2UserInfo;
import io.bosler.snap.passport.security.oauth2.user.OAuth2UserInfoFactory;
