...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleBranchAlreadyExistException(BadRequestException itemNotFoundException, WebRequest request) {
...
//
//        return buildErrorResponse(exception, "" + exception, HttpStatus.INTERNAL_SERVER_ERROR, request);
//    }
