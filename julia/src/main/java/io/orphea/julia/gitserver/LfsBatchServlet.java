package io.orphea.julia.gitserver;

import io.orphea.julia.lfs.server.LfsProtocolServletV2;
import io.orphea.julia.lfs.server.LfsRef;
...
public class LfsBatchServlet extends LfsProtocolServletV2 {
    ...
    private final FileLfsRepository lfsRepo;
    private final Path repoPath;
    private final FileRepositoryBuilder repositoryBuilder;
