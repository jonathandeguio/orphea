...
*/
 ...
 $(window).scroll(function(){      
        ...
        if ($(this).scrollTop() > 50){  
            ...
            document.getElementById("orphea-on-scroll").innerHTML = '<img class="orphea-icon-image" height="30" src="images/orphealogo.svg" alt="Orphea" />';
            ...
            document.getElementById("orphea-on-scroll").innerHTML = '<img class="orphea-icon-image" height="30" src="images/orphealogowhite.svg" alt="Orphea" />';
