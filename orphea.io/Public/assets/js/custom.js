(function ($) {
  ...
  function changeStyle() {
    ...
    options.find(".mode-layout").on("click", function () {
      // alert("hello")
      if (getCookie("menu") === "side") {
        // Cookies.set("theme","light");

        document.cookie = "menu=top";
      } else {
        // Cookies.set("theme","dark");
        document.cookie = "menu=side";
      }
  ...
  function setStyle() {
    ...
    if (getCookie("menu") === "top") {
      $body.removeClass("dsn-line-style");
    } else {
      $body.addClass("dsn-line-style");
    }
    // _dark.removeClass("v-dark").addClass("v-light");
    // _light.addClass("v-dark").removeClass("v-light");
  }
