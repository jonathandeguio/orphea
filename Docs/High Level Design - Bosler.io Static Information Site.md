...
# High Level Design - Bosler.io Static Information Site
...
<img src="Bosler Static Hosting v0.1.jpg">

*bosler.io architecture diagram*

Administration of the Google bucket is permitted through the GCP console.  The production website's bucket is hosted in the bosler-prod project.

User IDP is delivered through Bosler.io Google Workspace (Enterprise GMail & Google Docs etc.).

The bosler.io domain registrar is gandi.net.  

Gandi.net directs DNS requests for bosler.io to Cloudflare's name servers via two NS records:
<BR>**External nameservers**
<BR>decker.ns.cloudflare.com
<BR>kayleigh.ns.cloudflare.com

Within Cloudflare's DNS management there are two proxied CNAME records to *c.storage.googleapis.com*, one for bosler.io and one for the www subdomain.

There is also a page rule within cloudflare to perform a 301 redirect of www.bosler.io to bosler.io. 
...
The content of the site is held in the bosler.io Github project here: [https://github.com/Bosler-io/bosler.io](https://github.com/Bosler-io/bosler.io)
