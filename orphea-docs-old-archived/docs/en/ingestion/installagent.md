...
<div style="text-align: justify">A program called an Agent can be downloaded and added to your organizational network. It is managed through Orphea's Data Connection interface also known as Ignite.
...
Orphea's internal Agent software is called Ignite.
...
This only works for Linux and MacOS
