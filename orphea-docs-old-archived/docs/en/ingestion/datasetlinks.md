...
<div style="text-align: justify"> Creating a Link allows you to pull specific data from a Source and import it into Orphea. For instance, if you have a relational database Source that holds various tables, you can set up a Link to select a specific table and bring it into Orphea.
...
Once these steps are completed, the Link will be set up and ready to use. Data will be ingested from the Source into Orphea according to the schedule defined in the configuration.</div>
