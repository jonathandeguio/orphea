...
<div style="text-align: justify"> Orphea permet aux administrateurs de gérer les utilisateurs dans Orphea sur une seule page.

![Users Splash](../../_media/uman1.jpg)

IDans cette page située sous les paramètres Orphea, il est simple de voir rapidement tous les utilisateurs de l'environnement Orphea et les détails clés tels que :
...
La création d'un utilisateur dans Orphea est un processus simple.
