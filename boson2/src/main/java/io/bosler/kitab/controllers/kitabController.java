...
import io.bosler.kitab.library.repository.*;
...
import static io.bosler.sharedUtils.BackingFS.deleteDatasetFiles;
...
//                }
    ...
    ResponseEntity<Object> sampleData() {
        ...
        User boslerInternal = userService.getUser("bosler-internal");
...
//        userService.saveUser(new User(null, "Ashif Mohd", "ashif", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Ashif", "Mohd", "Aix", "https://ca.slack-edge.com/T0291A2684X-U02QYG1V692-be8bc7a76379-512", "ashif@bosler.io", "auto",AuthProvider.local, null, null, null,null,null,null,null));
//        userService.saveUser(new User(null, "Harsh Yadav", "harsh", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Harsh", "Yadav", "India", "https://avatars.githubusercontent.com/u/62005923?v=4", "harsh@bosler.io", "auto", "auto",AuthProvider.local, null, null, null,null,null,null,null));

        userService.saveUser(new User(null, "Bhagesh Dhankhar", "bhagesh", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Bhagesh", "Dhankhar", "India", "", "bhagesh@bosler.io", "auto", "auto",AuthProvider.local, null, null, null,null,null,null,null,RoleS3.USER,null));

        userService.saveUser(new User(null, "Amine Aouini", "amine", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Amine", "Aouini", "Aix", "", "auto", "auto", "amine@bosler.io",AuthProvider.local, null, null, null,null,null,null,null,RoleS3.USER,null));

        userService.saveUser(new User(null, "Anshul Dhankhar", "anshul", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Anshul", "Dhankhar", "Delhi", "", "auto", "auto", "anshul@bosler.io",AuthProvider.local, null, null, null,null,null,null,null,RoleS3.USER,null));

        userService.saveUser(new User(null, "Lakshay Dabas", "lakshay", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Lakshay", "Dabas", "Delhi", "", "auto", "auto", "lakshay@bosler.io",AuthProvider.local, null, null, null,null,null,null,null,RoleS3.USER, null));

        userService.saveUser(new User(null, "Manav Rathi", "manav", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Manav", "Rathi", "Delhi", "", "auto", "auto", "manav@bosler.io",AuthProvider.local, null, null, null,null,null,null,null,RoleS3.USER, null));

        userService.saveUser(new User(null, "Ankit Kumar", "ankit", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Ankit", "Kumar", "Delhi", "", "auto", "auto", "ankit@bosler.io",AuthProvider.local, null, null, null,null,null,null,null,RoleS3.USER, null));

        userService.saveUser(new User(null, "Vincent De-Guio", "vincent", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Vincent", "De-Guio", "Aix", "", "vincent@bosler.io", "auto", "auto",AuthProvider.local, null, null, null,null,null,null,null,RoleS3.USER, null));

        userService.saveUser(new User(null, "Jonathan De-Guio", "jonathan", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Jonathan", "De-Guio", "Aix", "https://ca.slack-edge.com/T0291A2684X-U0292AZES5D-aea210fd8068-192", "jonathan@bosler.io", "auto", "auto",AuthProvider.local, null, null, null,null,null,null,null,RoleS3.USER, null));

        userService.saveUser(new User(null, "James Morrish", "james", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "James", "Morrish", "Aix", "https://ca.slack-edge.com/T0291A2684X-U029Q9B53EX-e6b31ee5d73c-192", "james@bosler.io", "auto", "auto",AuthProvider.local, null, null, null,null,null,null,null,RoleS3.USER, null));

        userService.saveUser(new User(null, "Rakesh Malik", "rakesh", passwordEncoder.encode(System.getenv("DEFAULT_PASSWORD")), "Rakesh", "Malik", "Aix", "https://avatars.githubusercontent.com/u/38586615?s=400&u=b071181ada05d564a60d8f1631ecc5f79b9a518d&v=4", "rakesh@bosler.io", "auto", "auto",AuthProvider.local, null, null, null,null,null,null,null,RoleS3.USER, null));


//        FolderModel projectQuality = folderRepository.save(new FolderModel(null, "Quality", "This is a test Quality Project", "project", new UUID(0, 0), "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        FolderModel dataFolder = folderRepository.save(new FolderModel(null, "Data", "Data folder Quality Project", "folder", projectQuality.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        FolderModel igniteFolder = folderRepository.save(new FolderModel(null, "Ignite", "Ignite folder Quality Project", "folder", projectQuality.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        FolderModel logicFolder = folderRepository.save(new FolderModel(null, "Logic", "Logic folder Quality Project", "folder", projectQuality.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));

//        folderRepository.save(new FolderModel(null, "View", "View folder Quality Project", "folder", projectQuality.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//        FolderModel sampleDataset0 = folderRepository.save(new FolderModel(null, "Dataset0", "This is a dataset for testing purposes only.", "dataset", dataFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        FolderModel sampleDataset1 = folderRepository.save(new FolderModel(null, "Dataset1", "This is a dataset for testing purposes only.", "dataset", dataFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        FolderModel sampleDataset2 = folderRepository.save(new FolderModel(null, "Dataset2", "This is a dataset for testing purposes only.", "dataset", dataFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        FolderModel sampleDataset3 = folderRepository.save(new FolderModel(null, "Dataset3", "This is a dataset for testing purposes only.", "dataset", dataFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        FolderModel sampleDataset4 = folderRepository.save(new FolderModel(null, "Dataset4", "This is a dataset for testing purposes only.", "dataset", dataFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        FolderModel sampleDataset5 = folderRepository.save(new FolderModel(null, "Dataset5", "This is a dataset for testing purposes only.", "dataset", dataFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));

//        addSampleData(sampleDataset0, boslerInternal.getId());
//        addSampleData(sampleDataset1, boslerInternal.getId());
//        addSampleData(sampleDataset2, boslerInternal.getId());
//        addSampleData(sampleDataset3, boslerInternal.getId());
//        addSampleData(sampleDataset4, boslerInternal.getId());
//        addSampleData(sampleDataset5, boslerInternal.getId());

//        pipelineRepository.save(new PipelineModel(null, sampleDataset0.id, "main", sampleDataset1.id, "main", "none", "main", "none", "none", "active", "pipeline", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        pipelineRepository.save(new PipelineModel(null, sampleDataset0.id, "main", sampleDataset1.id, "master", "none", "main", "none", "none", "active", "pipeline", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        pipelineRepository.save(new PipelineModel(null, sampleDataset1.id, "master", sampleDataset2.id, "main", "none", "main", "none", "none", "active", "pipeline", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        pipelineRepository.save(new PipelineModel(null, sampleDataset1.id, "main", sampleDataset3.id, "main", "none", "main", "none", "none", "active", "pipeline", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        pipelineRepository.save(new PipelineModel(null, sampleDataset2.id, "main", sampleDataset4.id, "master", "none", "main", "none", "none", "active", "pipeline", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        pipelineRepository.save(new PipelineModel(null, sampleDataset3.id, "main", sampleDataset4.id, "main", "none", "main", "none", "none", "active", "pipeline", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        pipelineRepository.save(new PipelineModel(null, sampleDataset4.id, "main", sampleDataset5.id, "main", "none", "main", "none", "none", "active", "pipeline", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));

        GitCommit commitModel = new GitCommit();

        commitModel.setUsername(boslerInternal.getId().toString());
        commitModel.setEmail("rakesh@bosler.io");
        commitModel.setMessage("Sample Repository : Automatically created repository");


        FolderModel test = folderRepository.save(new FolderModel(null, "Test", "This is a test project for build testing", "project", new UUID(0, 0), "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
        FolderModel dataFolderTest = folderRepository.save(new FolderModel(null, "Data", "Data folder Test Project", "folder", test.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
        FolderModel logicFolderTest = folderRepository.save(new FolderModel(null, "Logic", "Logic folder Test Project", "folder", test.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//        FolderModel salesRecords = folderRepository.save(new FolderModel(null, "SalesRecords", "This is a dataset for testing purposes only.", "dataset", dataFolderTest.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));

//        addSampleData(salesRecords, boslerInternal.getId());
...
//        PermissionsMapping permissionsMappingProjectQuality = permissionMappingRepository.save(new PermissionsMapping(null, sampleOwnGroup.id, projectQuality.id, projectOwner, "active", null, null, null, null));
        PermissionsMapping permissionsMappingProjectTest = permissionMappingRepository.save(new PermissionsMapping(null, sampleOwnGroup.id, test.id, projectOwner, "active", new Date(), null, boslerInternal.getId(), null));
        ...
        if (!groupsRepository.existsByName("platform-administrators")) {
            ...
            groupService.addUsersToGroupMembers(boslerInternal.getId(), sampleGroupMembers, platformAdminGroup.getId());
        }

        groupService.addUsersToGroupMembers(boslerInternal.getId(), sampleGroupMembers, sampleOwnGroup.getId());
        groupService.addUsersToGroupOwners(boslerInternal.getId(), sampleGroupOwners, sampleOwnGroup.getId());

        // Tags

        TagsCategory businessTagsCategory = tagCategoryRepository.save(new TagsCategory(null,"Business", "This is a business category", true,null,new Date(),boslerInternal.getId(),null,null ));
        TagsCategory governanceTagsCategory = tagCategoryRepository.save(new TagsCategory(null,"Governance", "This is a governance category", true,null,new Date(),boslerInternal.getId(),null,null ));

        tagRepository.save(new Tags(null, "Internal", "This is an internal tag", "yellow", businessTagsCategory, new Date(),boslerInternal.getId(),null,null));
        tagRepository.save(new Tags(null, "Confidential", "This is an confidential tag", "red", businessTagsCategory, new Date(),boslerInternal.getId(),null,null));
        tagRepository.save(new Tags(null, "Restricted", "This is an restricted tag", "blue", businessTagsCategory, new Date(),boslerInternal.getId(),null,null));
        tagRepository.save(new Tags(null, "Non-Confidential", "This is an Non-Confidential", "green", businessTagsCategory, new Date(),boslerInternal.getId(),null,null));

        tagRepository.save(new Tags(null, "Governance", "This is an Governance tag", "orange", governanceTagsCategory, new Date(),boslerInternal.getId(),null,null));
        tagRepository.save(new Tags(null, "Non-Confidential", "This is an Non-Confidential tag", "cyan", governanceTagsCategory, new Date(),boslerInternal.getId(),null,null));

        boolean LOAD_IGNITE_SAMPLE_DATA = false;

//        if (LOAD_IGNITE_SAMPLE_DATA) {
//
//            FolderModel agentKitab = folderRepository.save(new FolderModel(null, "TestAgent - ServerP", "This agent is for testing.", "agent", igniteFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//            Agents agentsMacbook = agentRepository.save(new Agents(agentKitab.getId(), agentKitab.getName(), agentKitab.getDescription(), dataFolder.getId(), false, null, null, null, new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
...
//
//
//            FolderModel sourcesKitab = folderRepository.save(new FolderModel(null, "test_folder_serverp", "This is a test description", "source", igniteFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//            Sources sources = sourcesRepository.save(new Sources(sourcesKitab.getId(), sourcesKitab.getName(), sourceConfig, sourcesKitab.getDescription(), dataFolder.getId(), false, agentListIds, new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
...
//
//            FolderModel sourcesJDBCKitab = folderRepository.save(new FolderModel(null, "test_jdbc_serverp", "This is a test description", "source", igniteFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//            Sources sourcesJDBC = sourcesRepository.save(new Sources(sourcesJDBCKitab.getId(), sourcesJDBCKitab.getName(), sourceJDBCConfig, sourcesJDBCKitab.getDescription(), dataFolder.getId(), false, agentListIds, new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
...
//
//            FolderModel link1MacKitab = folderRepository.save(new FolderModel(null, "dataset0-folder", "This is a test link", "link", igniteFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//            Links links = linkRepository.save(new Links(link1MacKitab.getId(), link1MacKitab.getName(), link1MacKitab.getDescription(), sourceDatasetConfig, sampleDataset0.getId(), "master", sources.getId(), dataFolder.getId(), "overwrite", "None", null, "", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//
...
//
//            FolderModel linkMacKitab = folderRepository.save(new FolderModel(null, "dataset5-jdbc-postgres", "This is a test link", "link", igniteFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//            Links linksJDBC = linkRepository.save(new Links(linkMacKitab.getId(), linkMacKitab.getName(), linkMacKitab.getDescription(), sourceJDBCDatasetConfig, sampleDataset5.getId(), "master", sourcesJDBC.getId(), dataFolder.getId(), "overwrite", "None", null, "", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//
//            FolderModel agentMacKitab = folderRepository.save(new FolderModel(null, "TestAgent - ServerD", "This agent is for testing", "agent", igniteFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//            Agents agentsiMac = agentRepository.save(new Agents(agentMacKitab.getId(), agentMacKitab.getName(), agentMacKitab.getDescription(), dataFolder.getId(), false, null, null, null, new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
...
//
//            FolderModel sources1Kitab = folderRepository.save(new FolderModel(null, "test_folder_serverD", "This is a test description", "source", igniteFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//            Sources sources1 = sourcesRepository.save(new Sources(sources1Kitab.getId(), sources1Kitab.getName(), sourceConfig1, sources1Kitab.getDescription(), dataFolder.getId(), false, agentListIds1, new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
...
//
//            FolderModel links1Kitab = folderRepository.save(new FolderModel(null, "dataset2-folder", "This is a test link", "link", igniteFolder.id, "active", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//            Links links1 = linkRepository.save(new Links(links1Kitab.getId(), links1Kitab.getName(), links1Kitab.getDescription(), sourceDatasetConfig1, sampleDataset2.getId(), "master", sources1.getId(), dataFolder.getId(), "overwrite", "None", null, "", new Date(), new Date(), boslerInternal.getId(), boslerInternal.getId()));
//
//
//
//        }
    ...
    private void addSampleData(FolderModel sampleDataset0, UUID boslerInternalUserId) {

        branchRepository.save(new BranchModel(null, "master", sampleDataset0.getId(), UUID.randomUUID(), "raw", new Date(), new Date(), boslerInternalUserId, boslerInternalUserId));

        datasetRepository.save(new DatasetModel(sampleDataset0.id, sampleDataset0.name, null,
                new Date(), new Date(), boslerInternalUserId, boslerInternalUserId));
    }
