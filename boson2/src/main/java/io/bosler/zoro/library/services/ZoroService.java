package io.bosler.zoro.library.services;
...
import io.bosler.zoro.library.models.CustomSchemaModel;
...
public class ZoroService {
    ...
    private SparkSession createGSSession(String applicationName) throws IOException, ApiException {
        ...
        File file = new File(System.getenv("BOSLER_MOUNT_PATH") + "/google_creds.json");
        ...
        return SparkSession.builder()
                ...
                .config("spark.driver.extraJavaOptions", "-Dlog4jspark.root.logger=WARN,console")
                .config("google.cloud.auth.service.account.json.keyfile", System.getenv("BOSLER_MOUNT_PATH") + "/google_creds.json")
                .getOrCreate();
    }
    ...
    private SparkSession createHDFSSession(String applicationName) throws IOException, ApiException {
        ...
        return SparkSession.builder()
                ...
                .config("spark.kubernetes.namespace", "bosler")

//                    .config("spark.driver.host", "boson-spark-driver-pod.boson.bosler")
...
//                    .config("spark.deploy.mode", "cluster")
//                    .config("spark.kubernetes.namespace", "bosler")
//                    .config("spark.app.name", "bosler-spark-942199fc7efa")
//                    .config("spark.driver.extraJavaOptions", "-Dlog4jspark.root.logger=WARN,console")
//                    .config("spark.kubernetes.authenticate.driver.serviceAccountName", "spark")
//                    .config("spark.kubernetes.container.image", System.getenv("SPARK_PYSPARK_IMAGE"))
...
//        V1Pod pod = coreApi.readNamespacedPod("podName", "bosler", null);
