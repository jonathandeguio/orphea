...
import io.bosler.sharedUtils.KubernetesUtils;
...
import io.bosler.zoro.library.models.*;
import io.bosler.zoro.library.repository.SchemaRepository;
import io.bosler.zoro.library.repository.SparkResultsRepository;
...
//        }
        ...
        if (!file.isEmpty()) {
            ...
            if (Objects.equals(System.getenv("BACKING_FS"), "s3")) {
                ...
                BlobId blobId = BlobId.of(System.getenv("GS_BUCKET"), "bosler/datasets/" + datasetId + "/" + branch + "/" + file.getOriginalFilename());
...
//                System.out.println(content);
                ...
                Path path = new Path("/bosler/datasets/" + datasetId + "/" + branch + "/" + file.getOriginalFilename());
...
//        sparkResults.setResults(result);
    ...
    private void runSparkColumnStatsJobWithKubernetes(UUID userId, ColumnStatsModel columnStatsModel, UUID resultsId) throws Exception {
        ...
        new KubernetesUtils().sparkWithKubernetes(envVars, "io.bosler.ColumnStats","columnstats",  1, "512M", 1, 0);
    }
...
//        }
        ...
        new KubernetesUtils().sparkWithKubernetes(envVars, "io.bosler.Dataset","dataset",  1, "512M", 1, 0);
    }
