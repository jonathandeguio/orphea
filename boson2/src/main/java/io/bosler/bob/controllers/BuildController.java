package io.bosler.bob.controllers;

import io.bosler.bob.library.models.*;
...
import static io.bosler.sharedUtils.Redis.deleteCache;
import static io.bosler.sharedUtils.Redis.deleteCacheWithWildCard;
...
public class BuildController {
    ...
    public ResponseEntity<Object> abortBuild(Principal principal,
        ...
        List<V1Pod> podList =
                coreApi
                        .listNamespacedPod("bosler", "false", null, null,
        ...
        if (pod != null) {
            deletePod("bosler", pod.getMetadata().getName());
        }
...
//        template.convertAndSend("/topic/build/" + buil + "/" + branch, socketMessage);
    ...
    public ResponseEntity<Object> log(Principal principal,
        ...
        /*
//        kubectl -n bosler logs bosler-spark-buildId-driver
...
//            logOptions.setFollow(true); // set to true to follow the logs as they are written
            ...
            String log = coreApi.readNamespacedPodLog(pod.getMetadata().getName(), "bosler", null, true, null,
