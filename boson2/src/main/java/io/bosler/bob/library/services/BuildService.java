package io.bosler.bob.library.services;
...
public class BuildService {
    ...
    public ResponseEntity<Object> buildPythonTransform(UUID userId,
        ...
        v1ObjectMeta.name("bosler-spark-build-" + buildId.toString().substring(buildId.toString().lastIndexOf('-') + 1));
        ...
        fractalTemplatesToken.setName("bosler-secret");
...
//            return new ResponseEntity<>("Launched the builds by source", HttpStatus.OK);
    ...
    public ResponseEntity<Object> buildSqlTransform(UUID userId,
        ...
        new KubernetesUtils().sparkWithKubernetes(envVars, "io.bosler.SqlTransform", trigger + "-sql", cores, memory, numberOfExecutors, failureRetries);
