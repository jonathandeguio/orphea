...
import io.bosler.sharedUtils.Response.BadRequestException;
...
//        template.convertAndSend("/topic/repository/" + repositoryId + "/" + branch, textMessage);
    ...
    ResponseEntity<Object> startJupyter(Principal principal, HttpServletRequest httpServletRequest) throws Exception {
        ...
        envVars.add(new V1EnvVar().name("BOSLER_USERID").value(userId.toString()));
        envVars.add(new V1EnvVar().name("BASE_URL").value(System.getenv("BASE_URL")));
        envVars.add(new V1EnvVar().name("BOSLER_API").value("http://boson:8080"));
        envVars.add(new V1EnvVar().name("DB_USERNAME").valueFrom(new V1EnvVarSource().secretKeyRef(new V1SecretKeySelector().name("bosler-secret").key("boson-db-username"))));
        envVars.add(new V1EnvVar().name("DB_PASSWORD").valueFrom(new V1EnvVarSource().secretKeyRef(new V1SecretKeySelector().name("bosler-secret").key("boson-db-password"))));
        ...
        envVars.add(new V1EnvVar().name("NOTEBOOK_DIR").value(System.getenv("BOSLER_MOUNT_PATH") + "/git/cloned"));
        envVars.add(new V1EnvVar().name("NOTEBOOK_TOKEN").value(token));
        envVars.add(new V1EnvVar().name("NOTEBOOK_TOKEN_TTL").value(tokenTTL));

        envVars.add(new V1EnvVar().name("TOKEN_SECRET").valueFrom(new V1EnvVarSource().secretKeyRef(new V1SecretKeySelector().name("bosler-secret").key("token-secret"))));
        envVars.add(new V1EnvVar().name("FRACTAL_TEMPLATES_TOKEN").valueFrom(new V1EnvVarSource().secretKeyRef(new V1SecretKeySelector().name("bosler-secret").key("fractal-templates-token"))));
        envVars.add(new V1EnvVar().name("MINIO_ACCESS_KEY").valueFrom(new V1EnvVarSource().secretKeyRef(new V1SecretKeySelector().name("bosler-secret").key("minio-username"))));
        envVars.add(new V1EnvVar().name("MINIO_SECRET_KEY").valueFrom(new V1EnvVarSource().secretKeyRef(new V1SecretKeySelector().name("bosler-secret").key("minio-password"))));
        envVars.add(new V1EnvVar().name("GOOGLE_CLOUD_CREDENTIALS").valueFrom(new V1EnvVarSource().secretKeyRef(new V1SecretKeySelector().name("bosler-secret").key("google-cloud-credentials"))));
        ...
        volumeMounts.add(new V1VolumeMount().mountPath("/bosler").name("bosler-nfs-volume"));
        container.setVolumeMounts(volumeMounts);

        container.setWorkingDir(System.getenv("BOSLER_MOUNT_PATH"));
        ...
        pvcVolumeSource.setClaimName("bosler-pvc");

        V1Volume boslerNfsVolume = new V1Volume();
        boslerNfsVolume.setName("bosler-nfs-volume");
        boslerNfsVolume.setPersistentVolumeClaim(pvcVolumeSource);

        List<V1Volume> volumes = new ArrayList<>();
        volumes.add(boslerNfsVolume);
        ...
        annotations.put("beta.cloud.google.com/backend-config", "{\"default\": \"bosler-backend-config\"}");
        ...
        String ingressName = "bosler-ingress";
        ...
        ingressRule.setHost(System.getenv("dev.bosler.io"));  // TODO : Change this to auto
