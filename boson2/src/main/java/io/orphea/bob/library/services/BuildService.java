package io.orphea.bob.library.services;
...
public class BuildService {
    ...
    public ResponseEntity<Object> buildPythonTransform(UUID userId,
        ...
        v1ObjectMeta.namespace("orphea");
        v1ObjectMeta.name("orphea-spark-build-" + buildId.toString().substring(buildId.toString().lastIndexOf('-') + 1));
        ...
        if (Objects.equals(System.getenv("BACKING_FS"), "gs")) {
            ...
            googleCloudCredentials.setName("orphea-secret");
        ...
        fractalTemplatesToken.setName("orphea-secret");
        ...
        envVars.put("ORPHEA_API", "http://boson:8080");
...
//        spec.setImagePullPolicy("IfNotPresent");
        ...
        try {
            ...
            String namespace = "orphea"; // String | The custom resource's namespace
...
//            return new ResponseEntity<>("Launched the builds by source", HttpStatus.OK);
    ...
    public ResponseEntity<Object> buildSqlTransform(UUID userId,
        ...
        new KubernetesUtils().sparkWithKubernetes(envVars, "io.orphea.SqlTransform", trigger + "-sql", cores, memory, numberOfExecutors, failureRetries);
