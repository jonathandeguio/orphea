...
save_container_image() {
  ...
  images=("boson:latest" "frontend:latest" "bosler-docs:latest")
  image_names=("boson" "frontend" "bosler-docs")
...
pull_images() {
  ...
  repos=("git@github.com:Bosler-io/frontend.git" "git@github.com:Bosler-io/boson.git" "git@github.com:Bosler-io/bosler-docs.git")
