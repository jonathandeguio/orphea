...
private[spark] object UIUtils extends Logging {
  ...
  def commonHeaderNodes(request: HttpServletRequest): Seq[Node] = {
    ...
    <link rel="stylesheet"
          href={prependBaseUri(request, "/bosler-shs/static/bootstrap.min.css")} type="text/css"/>
    <link rel="stylesheet"
          href={prependBaseUri(request, "/bosler-shs/static/vis-timeline-graph2d.min.css")} type="text/css"/>
    <link rel="stylesheet" href={prependBaseUri(request, "/bosler-shs/static/webui.css")} type="text/css"/>
    <link rel="stylesheet"
          href={prependBaseUri(request, "/bosler-shs/static/timeline-view.css")} type="text/css"/>
          
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins" />
    
    <script src={prependBaseUri(request, "/bosler-shs/static/sorttable.js")} ></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/jquery-3.5.1.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/vis-timeline-graph2d.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/bootstrap.bundle.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/initialize-tooltips.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/table.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/timeline-view.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/log-view.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/webui.js")}></script>
  ...
  def vizHeaderNodes(request: HttpServletRequest): Seq[Node] = {
    <link rel="stylesheet"
          href={prependBaseUri(request, "/bosler-shs/static/spark-dag-viz.css")} type="text/css" />
    <script src={prependBaseUri(request, "/bosler-shs/static/d3.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/dagre-d3.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/graphlib-dot.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/spark-dag-viz.js")}></script>
  }

  def dataTablesHeaderNodes(request: HttpServletRequest): Seq[Node] = {
    <link rel="stylesheet" href={prependBaseUri(request,
      "/bosler-shs/static/jquery.dataTables.1.10.20.min.css")} type="text/css"/>
    <link rel="stylesheet"
          href={prependBaseUri(request, "/bosler-shs/static/dataTables.bootstrap4.1.10.20.min.css")}
          type="text/css"/>
    <link rel="stylesheet"
          href={prependBaseUri(request, "/bosler-shs/static/jsonFormatter.min.css")} type="text/css"/>
    <link rel="stylesheet"
          href={prependBaseUri(request, "/bosler-shs/static/webui-dataTables.css")} type="text/css"/>
    <script src={prependBaseUri(request, "/bosler-shs/static/jquery.dataTables.1.10.20.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/jquery.cookies.2.2.0.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/jquery.blockUI.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/dataTables.bootstrap4.1.10.20.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/jsonFormatter.min.js")}></script>
    <script src={prependBaseUri(request, "/bosler-shs/static/jquery.mustache.js")}></script>
  }
    ...
    <html>
      <head>
        ...
        <link rel="shortcut icon"
              href={prependBaseUri(request, "/bosler-shs/static/bosler-logo.png")}></link>
          ...
          <div class="navbar-header">
            <div class="navbar-brand">
              <a href={prependBaseUri(request, "/")}>
                <!--<img src={prependBaseUri(request, "/bosler-shs/static/spark-logo-77x50px-hd.png")} />-->
            ...
            <div class="col-12">
              <h3 style="vertical-align: middle; display: inline-block;">
                <a style="text-decoration: none" href={prependBaseUri(request, "/")}>
                  <!--<img src={prependBaseUri(request, "/bosler-shs/static/spark-logo-77x50px-hd.png")} />-->
                  <!--<span class="version" style="margin-right: 15px;">{org.apache.spark.SPARK_VERSION}</span>-->
                </a>
                {title}
              </h3>
            </div>
