...
save_container_image() {
  ...
  images=("boson:latest" "frontend:latest" "orphea-docs:latest")
  image_names=("boson" "frontend" "orphea-docs")
...
pull_images() {
  ...
  repos=("git@github.com:Orphea-io/frontend.git" "git@github.com:Orphea-io/boson.git" "git@github.com:Orphea-io/orphea-docs.git")
