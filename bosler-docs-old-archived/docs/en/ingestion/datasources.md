...
<div style="text-align: justify"> A Data Source is any external data system that can be connected to Bosler. Examples of a Data Source include, but are not limited to:
