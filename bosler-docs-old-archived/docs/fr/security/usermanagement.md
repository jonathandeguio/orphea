...
<div style="text-align: justify"> Bosler permet aux administrateurs de gérer les utilisateurs dans Bosler sur une seule page.

![Users Splash](../../_media/uman1.jpg)

IDans cette page située sous les paramètres Bosler, il est simple de voir rapidement tous les utilisateurs de l'environnement Bosler et les détails clés tels que :
...
La création d'un utilisateur dans Bosler est un processus simple.
...
![Edit User](../../_media/uman4.jpg)</div>
