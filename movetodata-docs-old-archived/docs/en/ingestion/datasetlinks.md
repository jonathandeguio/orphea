...
Once these steps are completed, the Link will be set up and ready to use. Data will be ingested from the Source into MoveToData according to the schedule defined in the configuration.</div>
