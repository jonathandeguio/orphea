...
<div style="text-align: justify"> A Data Source is any external data system that can be connected to MoveToData. Examples of a Data Source include, but are not limited to:
...
To establish a connection to MoveToData, a configured Data Source is required. It is important to note that a Data Source cannot be used directly in MoveToData, data must be synchronised into a dataset before it can be utilized.
