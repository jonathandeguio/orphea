...
*/
 ...
 $(window).scroll(function(){      
        ...
        if ($(this).scrollTop() > 50){  
            ...
            document.getElementById("movetodata-on-scroll").innerHTML = '<img class="movetodata-icon-image" height="30" src="images/movetodatalogo.svg" alt="MoveToData" />';
            ...
            document.getElementById("movetodata-on-scroll").innerHTML = '<img class="movetodata-icon-image" height="30" src="images/movetodatalogowhite.svg" alt="MoveToData" />';
