...
export const projectCreateReducer = (state = {}, action: any) => {
  switch (action.type) {
...
export const folderCreateReducer = (state = {}, action: any) => {
  switch (action.type) {
...
export const projectDetailsReducer = (state = {}, action: any) => {
  switch (action.type) {
...
export const folderDetailsReducer = (state = {}, action: any) => {
  switch (action.type) {
