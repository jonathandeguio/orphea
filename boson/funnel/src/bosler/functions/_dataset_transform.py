...
from bosler.internal import Kitab, Build, Bosler, spark_session, Logging, Constants
import pandas as pd
...
#     """
#
#     response = Bosler().functions(method="GET", endpoint=f"/api/dataset/schema/{dataset_id}/{branch}", payload=None,
#                             payload_type=None)
#
