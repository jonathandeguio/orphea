...
import io.bosler.platform.library.models.Versions;
...
//        }
        ...
        switch (backingFS) {
            ...
            case "gs":
                ...
                BlobId blobId = BlobId.of(System.getenv("GS_BUCKET"), "bosler/file/" + fileId + "/master/" + folderModel.getId());
            ...
            case "hdfs":
                ...
                FSDataInputStream fileOpen = fs.open(new Path("/bosler/file/" + fileId + "/master/" + folderModel.getId()));
