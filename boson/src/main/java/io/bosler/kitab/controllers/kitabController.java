...
import io.bosler.build.library.services.KitabService;
...
import io.bosler.dataset.library.repository.SchemaRepository;
...
import io.bosler.kitab.library.GlobalResourceSearchFilterDTO;
...
import io.bosler.kitab.library.models.*;
import io.bosler.kitab.library.repository.*;
import io.bosler.kitab.library.requests.NewProjectRequest;
import io.bosler.kitab.library.services.ResourceService;
import io.bosler.passport.enums.AuthProvider;
import io.bosler.passport.exception.BadRequestException;
...
import io.bosler.sharedutils.BackFsFileUtils;
import io.bosler.sharedutils.DTO.PageToPageDTOMapper;
import io.bosler.sharedutils.DeletionInBackingFS;
...
import static io.bosler.sharedutils.language.labels.getLabel;
...
//                }
    ...
    ResponseEntity<Object> sampleData(Principal principal, @PathVariable("sampleDataType") String sampleDataType) {
        ...
        User boslerInternal = userService.getUser(PlatformInternal.toString());
        final String defaultPassword = "bosler2024";

        if (Objects.equals(sampleDataType, "development")) {

            userService.saveUser(new User(null, "Bhagesh Dhankhar", "bhagesh", defaultPassword, "Bhagesh", "Dhankhar", "India", "", "bhagesh@bosler.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));

//            userService.saveUser(new User(null, "Amine Aouini", "amine", defaultPassword, "Amine", "Aouini", "Aix", "", "amine@bosler.io", AuthProvider.local, null, null, null, null, null, null, null));

            userService.saveUser(new User(null, "Anshul Dhankhar", "anshul", defaultPassword, "Anshul", "Dhankhar", "Delhi", "", "anshul@bosler.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));

//            userService.saveUser(new User(null, "Lakshay Dabas", "lakshay", defaultPassword, "Lakshay", "Dabas", "Delhi", "", "lakshay@bosler.io", AuthProvider.local, null, null, null, null, null, null, null));

//            userService.saveUser(new User(null, "Manav Rathi", "manav", defaultPassword, "Manav", "Rathi", "Delhi", "", "manav@bosler.io", AuthProvider.local, null, null, null, null, null, null, null));

            userService.saveUser(new User(null, "Ankit Kumar", "ankit", defaultPassword, "Ankit", "Kumar", "Delhi", "https://ca.slack-edge.com/T0291A2684X-U02H75ZLERE-ac5c85b6aead-192", "ankit@bosler.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));

//            userService.saveUser(new User(null, "Suryansh Kumar", "suryansh", defaultPassword, "Suryansh", "Kumar", "Odisa", "https://ca.slack-edge.com/T0291A2684X-U054QC09W72-0ad6d0241cb3-192", "suryansh@bosler.io", AuthProvider.local, null, null, null, null, null, null, null,null));

//            userService.saveUser(new User(null, "Jonathan De-Guio", "jonathan", defaultPassword, "Jonathan", "De-Guio", "Aix", "https://ca.slack-edge.com/T0291A2684X-U0292AZES5D-aea210fd8068-192", "jonathan@bosler.io", AuthProvider.local, null, null, null, null, null, null, null));

//            userService.saveUser(new User(null, "James Morrish", "james", defaultPassword, "James", "Morrish", "Aix", "https://ca.slack-edge.com/T0291A2684X-U029Q9B53EX-e6b31ee5d73c-192", "james@bosler.io", AuthProvider.local, null, null, null, null, null, null, null));

            userService.saveUser(new User(null, "Rakesh Malik", "rakesh", defaultPassword, "Rakesh", "Malik", "Aix", "https://avatars.githubusercontent.com/u/38586615?s=400&u=b071181ada05d564a60d8f1631ecc5f79b9a518d&v=4", "rakesh@bosler.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));

        } else if (Objects.equals(sampleDataType, "demo")) {

            userService.saveUser(new User(null, "Vincent De-Guio", "vincent", "boslerdemo2023", "Vincent", "De-Guio", "Aix", "", "vincent@bosler.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));
            userService.saveUser(new User(null, "Jonathan De-Guio", "jonathan", "boslerdemo2023", "Jonathan", "De-Guio", "Aix", "https://ca.slack-edge.com/T0291A2684X-U0292AZES5D-aea210fd8068-192", "jonathan@bosler.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));
            userService.saveUser(new User(null, "Yann Koziareck", "yann", "boslerdemo2023", "Yann", "Koziareck", "Aix", "https://ca.slack-edge.com/T0291A2684X-U055HR5QN84-g8fe558ccafb-512", "yann@bosler.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));
            userService.saveUser(new User(null, "Rakesh Malik", "rakesh", "boslerdemo2023", "Rakesh", "Malik", "Aix", "https://avatars.githubusercontent.com/u/38586615?s=400&u=b071181ada05d564a60d8f1631ecc5f79b9a518d&v=4", "rakesh@bosler.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));

            userService.saveUser(new User(null, "Romain De-Guio", "romain", "boslerdemo2023", "Romain", "De-Guio", "Aix", "", "romain.deguio@bosler.fr", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));

            userService.saveUser(new User(null, "Melanie Le Bot", "melanie", "boslerdemo2023", "Melanie", "Le Bot", "Aix", "", "melanie.lebot@bosler.fr", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));

            userService.saveUser(new User(null, "Anjali Malik", "anjali", "boslerdemo2023", "Anjali", "Malik", "Toulouse", "", "anjali@rkmalik.co.uk", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));
            userService.saveUser(new User(null, "Olivier Guide", "olivier", "boslerdemo2023", "Olivier", "Guide", "Aix", "", "olivier@bosler.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));
            userService.saveUser(new User(null, "Laurent ", "laurent", "boslerdemo2023", "Laurent", "Moysoulier", "Aix", "", "moysoulier.l@gmail.com", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));
        ...
        if (groupsRepository.existsByName("platform-administrators")) {
            ...
            groupService.addUsersToGroupOwners(boslerInternal.getId(), sampleGroupMembers, platformAdminGroup.getId());
        }
        // Tags
        ...
        tagRepository.save(new Tags(null, "Internal", "This is an internal tag", "yellow", new Date(), boslerInternal.getId(), null, null, businessTagsCategory));
        tagRepository.save(new Tags(null, "Confidential", "This is an confidential tag", "red", new Date(), boslerInternal.getId(), null, null, businessTagsCategory));
        tagRepository.save(new Tags(null, "Restricted", "This is an restricted tag", "blue", new Date(), boslerInternal.getId(), null, null, businessTagsCategory));
        tagRepository.save(new Tags(null, "Non-Confidential", "This is an Non-Confidential", "green", new Date(), boslerInternal.getId(), null, null, businessTagsCategory));

        tagRepository.save(new Tags(null, "Governance", "This is an Governance tag", "orange", new Date(), boslerInternal.getId(), null, null, governanceTagsCategory));
        tagRepository.save(new Tags(null, "Non-Confidential", "This is an Non-Confidential tag", "cyan", new Date(), boslerInternal.getId(), null, null, governanceTagsCategory));
