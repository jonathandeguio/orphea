    ...
    public Map<String, Object> getFileInputStream(UUID id) throws Exception {
        ...
        switch (backingFS) {
            ...
            case "gs":
                ...
                BlobId blobId = BlobId.of(System.getenv("GS_BUCKET"), "bosler/file/" + id + "/file/" + resourceModel.getId());
            ...
            case "hdfs":
                ...
                FSDataInputStream fileOpen = fs.open(new Path("/bosler/file/" + id + "/file/" + resourceModel.getId()));
                headers.setContentType(MediaType.APPLICATION_OCTET_STREAM);
                headers.setContentDispositionFormData("attachment", resourceModel.getName());
