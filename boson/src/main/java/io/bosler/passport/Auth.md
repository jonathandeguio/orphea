...
### You can add more permissions in the `src/main/java/io/bosler/passport/security/CustomMethodSecurityExpressionRoot.java`
...
After this you can add its SpEL to the `src/main/java/io/bosler/passport/library/Auth.java` file or use directly.
