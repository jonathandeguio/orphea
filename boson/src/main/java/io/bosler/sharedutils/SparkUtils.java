    ...
    public static Map<String, String> getSparkConf() throws EnvConfigurationException {
        ...
        switch (backingFs) {
            ...
            case "gs":
                ...
                sparkConf.put("spark.eventLog.dir", "gs://" + System.getenv("GS_BUCKET") + "/bosler/spark-streaming");
            ...
            case "hdfs":
                sparkConf.put("spark.eventLog.enabled", "true");
                sparkConf.put("spark.eventLog.dir", System.getenv("HDFS_ENDPOINT") + "/bosler/spark-streaming");
...
//            String warehouseLocation = System.getenv("LOCAL_FS_DIRECTORY") + "/SQLTransforms/BoslerTransformTemporary/tmp";
