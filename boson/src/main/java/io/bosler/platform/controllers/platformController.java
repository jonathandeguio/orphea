...
import io.bosler.platform.library.repository.SMTPConfigRepository;
...
public class platformController {
    ...
    ResponseEntity<Object> decryptLicenseKey(@RequestBody String licenseKey) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ErrorDTO.builder().status(HttpStatus.BAD_REQUEST.value()).error("Invalid License Key").description("Please Contact Bosler Team").build());
        }
    }
}
