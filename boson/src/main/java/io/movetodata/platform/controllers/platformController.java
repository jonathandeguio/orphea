...
import io.movetodata.platform.library.repository.DataMartConfigRepository;
...
public class platformController {
    ...
    ResponseEntity<Object> decryptLicenseKey(@RequestBody String licenseKey) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ErrorDTO.builder().status(HttpStatus.BAD_REQUEST.value()).error("Invalid License Key").description("Please Contact MoveToData Team").build());
        }
    }
}
