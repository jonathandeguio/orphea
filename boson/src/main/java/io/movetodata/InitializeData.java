...
import io.movetodata.platform.library.models.*;
import io.movetodata.platform.library.repository.*;
...
//                        socket.close();
            ...
            if (System.getenv("BACKING_FS").equals("s3")) { // Create directories if not exists in s3
                ...
                BlobId datasetPath = BlobId.of(System.getenv("GS_BUCKET"), "movetodata/dataset/");
                BlobId filePath = BlobId.of(System.getenv("GS_BUCKET"), "movetodata/file/");
                ...
                Path datasetPath = new Path("/movetodata/dataset");
                Path filePath = new Path("/movetodata/file");
                ...
                String movetodataPath = System.getenv("LOCAL_FS_DIRECTORY");
                ...
                File movetodataPathDirectory = new File(movetodataPath);

                if (!movetodataPathDirectory.exists()) {
                    boolean movetodataResultDir = movetodataPathDirectory.mkdirs();
                }
            ...
            if (!userRepository.existsByUsername("platform-administrator")) {
                userService.saveUser(new User(null, "Platform Administrator", "platform-administrator", defaultPassword, "Platform", "Administrator", "None",
                        "",
                        "platform-administrator@movetodata.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));
            }
            ...
            if (!userRepository.existsByUsername(PlatformInternal.toString())) {
                User platformInternal = userService.saveUser(new User(null, "Platform Internal", PlatformInternal.toString(), "b071181ada05d564a60d", "Platform", "Internal", "None",
                        "",
                        "platform-internal@movetodata.io", AuthProvider.local, null, null, false, null, false, null, new UserPreferences(), new NotificationPreferences().getId(), null, null, null, null, null));
            }
