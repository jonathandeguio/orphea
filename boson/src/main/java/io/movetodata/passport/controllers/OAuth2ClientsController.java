...
//import io.movetodata.passport.library.service.SSOService;
import io.movetodata.passport.library.models.OAuth2Client;
import io.movetodata.passport.library.repository.OAuth2ClientRepository;
...
@CrossOrigin
@RestController
@RequestMapping("/api/passport/oath2")
