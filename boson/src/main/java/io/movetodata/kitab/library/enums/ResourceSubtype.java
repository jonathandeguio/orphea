...
public enum ResourceSubtype {
    ...
    // Datset
    RAWDATASET("Raw dataset file, represented in grey on platform"),
    BUILDDATASET("Build dataset file, represented in blue on platform"),
    LIVEDATASET("Live dataset file, represented in red on platform"),
    ...
    //----- Mysql -----
    // Other
    MYSQL_SCHEMAFOLDER("Schema Folder"),

    // Types

    //----- Maria -----
    // Other
    MARIA_SCHEMAFOLDER("Schema Folder"),

    // Types
    //----- Postgres -----
    // Other
    POSTGRES_SCHEMAFOLDER("Schema Folder"),
    // Types
    POSTGRES_VARCHAR("Varchar"),
    POSTGRES_DECIMAL("Decimal"),
    POSTGRES_INT("int"),
    POSTGRES_BOOLEAN("Boolean"),
    POSTGRES_CHAR("Character"),
    POSTGRES_DATE("date"),
