...
### You can add more permissions in the `src/main/java/io/orphea/passport/security/CustomMethodSecurityExpressionRoot.java`
...
After this you can add its SpEL to the `src/main/java/io/orphea/passport/library/Auth.java` file or use directly.
