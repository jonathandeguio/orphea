...
import io.orphea.sharedutils.DTO.FileNode;
import io.orphea.sharedutils.Serializers.ResourceModelSerializer;
import lombok.*;
...
public class ResourceModel implements FileNode<UUID>, OrpheaUtils, IResource {
    @Id
