...
import io.orphea.platform.library.models.Versions;
...
//        }
        ...
        switch (backingFS) {
            ...
            case "gs":
                ...
                BlobId blobId = BlobId.of(System.getenv("GS_BUCKET"), "orphea/file/" + fileId + "/master/" + folderModel.getId());
            ...
            case "hdfs":
                ...
                FSDataInputStream fileOpen = fs.open(new Path("/orphea/file/" + fileId + "/master/" + folderModel.getId()));
