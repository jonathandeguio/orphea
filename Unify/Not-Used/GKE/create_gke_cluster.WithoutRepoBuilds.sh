...
###  HASHED OUT FOR REMOTE HOSTED REPOS ### 
...
#gcloud projects add-iam-policy-binding $PROJECT_ID \
#    --member="serviceAccount:boslerbuilds@${PROJECT_ID}.iam.gserviceaccount.com" \
...
## Create remaining trigger for boson!
...
#
#
# Set up custom IAM Roles
#gcloud projects set-iam-policy $PROJECT_ID ./iam-policies/custom-policy.json
