...
--create-disk=auto-delete=yes,boot=yes,device-name=instance-1,image=projects/centos-cloud/global/images/centos-7-v20211214,mode=rw,size=100,type=projects/bosler-foo/zones/$COMPUTE_ZONE/diskTypes/pd-standard \
--create-disk=auto-delete=yes,device-name=$DISK_TAG,mode=rw,name=$DISK_TAG,size=1000,type=projects/bosler-foo/zones/$COMPUTE_ZONE/diskTypes/pd-standard \
...
# e.g.
# gcloud beta compute ssh --zone "$COMPUTE_ZONE" "bnp-instance-1"  --tunnel-through-iap --project "bosler-foo"
# sudo lsblk
