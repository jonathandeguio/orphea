...
- Move storage buckets for the websites to a safe tenant (main bosler.io?)
- Set up an external image repo - look at options (main bosler.io?)
...
### Trello board:  https://trello.com/b/4qTPpA7r/bosler-infrastructure
