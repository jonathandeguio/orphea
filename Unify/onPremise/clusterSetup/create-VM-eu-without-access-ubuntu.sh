...
# Allow DNS egress
gcloud compute --project=$PROJECT_ID firewall-rules create $NETWORK_TAG-egress-dns \
...
gcloud compute --project=$PROJECT_ID firewall-rules create bnp-secure-firewall-network-lb \
    --direction=INGRESS --priority=1000 --network=$NETWORK_TAG --action=ALLOW --rules=all \
...
gcloud compute instances create $INSTANCE_TAG --project=$PROJECT_ID \
    ...
    --service-account=435091822251-compute@developer.gserviceaccount.com \
    --scopes=https://www.googleapis.com/auth/devstorage.read_only,https://www.googleapis.com/auth/logging.write,https://www.googleapis.com/auth/monitoring.write,https://www.googleapis.com/auth/servicecontrol,https://www.googleapis.com/auth/service.management.readonly,https://www.googleapis.com/auth/trace.append \
    --create-disk=auto-delete=yes,boot=yes,device-name=instance-1,image=projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2004-focal-v20230524,mode=rw,size=100,type=projects/$PROJECT_ID/zones/us-central1-c/diskTypes/pd-standard \
    --create-disk=auto-delete=yes,device-name=$DISK_TAG,mode=rw,name=bnp-disk-1,size=1000,type=projects/$PROJECT_ID/zones/us-central1-c/diskTypes/pd-standard \
...
# e.g.
# gcloud beta compute ssh --zone "us-central1-c" "bnp-instance-1"  --tunnel-through-iap --project "$PROJECT_ID"
# sudo lsblk
