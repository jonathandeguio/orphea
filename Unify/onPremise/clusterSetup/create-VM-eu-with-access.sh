...
# 4 CPU / 16GB RAM Standard VM with Standard Disks (100GB Boot, 100GB External)
...
--service-account=$SERVIE_ACCOUNT \
--scopes=https://www.googleapis.com/auth/devstorage.read_only,https://www.googleapis.com/auth/logging.write,https://www.googleapis.com/auth/monitoring.write,https://www.googleapis.com/auth/servicecontrol,https://www.googleapis.com/auth/service.management.readonly,https://www.googleapis.com/auth/trace.append \
--tags=http-server,https-server --create-disk=auto-delete=yes,boot=yes,device-name=instance-1,image=projects/centos-cloud/global/images/centos-7-v20211214,mode=rw,size=100,type=projects/$PROJECT_ID/zones/$COMPUTE_ZONE/diskTypes/pd-standard \
--create-disk=auto-delete=yes,device-name=$DISK_TAG,mode=rw,name=$DISK_TAG,size=100,type=projects/$PROJECT_ID/zones/$COMPUTE_ZONE/diskTypes/pd-standard \
...
# e.g.
# gcloud beta compute ssh --zone "$COMPUTE_ZONE" "bnp-instance-1"  --tunnel-through-iap --project "$PROJECT_ID"
# sudo lsblk
