...
cat $HELM_CHART/$HELM_VALUES | sed "s/googleCloudCredentials:.*/googleCloudCredentials: $CLOUD_SA_KEY/g" > $HELM_CHART/$HELM_VALUES.new
mv $HELM_CHART/$HELM_VALUES.new $HELM_CHART/$HELM_VALUES
...
# helm install bosler bosler-gke -f $HELM_CHART/$HELM_VALUES
