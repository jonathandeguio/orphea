...
BOSLER_API = os.environ.get('BOSLER_API') if os.environ.get('BOSLER_API') else "http://localhost:8080"
...
PHYSICAL_ENDPOINT = os.environ.get("PHYSICAL_ENDPOINT") if os.environ.get("PHYSICAL_ENDPOINT") else "/Users/commonaccount/bosler/localFS/dataset"