...
export const chartConfig: { [key: string]: any } = {
  ...
  candlestickChart: {
    ...
    candlestickDate: undefined,
    candlestickOpen: undefined,
    candlestickHigh: undefined,
    candlestickLow: undefined,
    candlestickClose: undefined,
    meta: {
      threshold: "DISABLED",
      isSingleDirection: true,
      isSingleSeries: true,
    ...
    customization: {
      series: false,
      header: "candlestickChart",
    },
  },
  // Rang 9 — Parallel coordinates
  parallelChart: {
    ...
    customization: {
      series: false,
      header: "parallelChart",
    },
  },
  // Rang 10 — ThemeRiver
  themeRiverChart: {
    chartType: "themeRiverChart",
    themeRiverDate: undefined,
    themeRiverValue: undefined,
    themeRiverCategory: undefined,
    meta: {
      threshold: "DISABLED",
      isSingleDirection: true,
      isSingleSeries: false,
    ...
    customization: {
      series: false,
      header: "themeRiverChart",
    },
  },
  // Rang 11 — PictorialBar
  pictorialBarChart: {
    ...
    customization: {
      series: false,
      header: "pictorialBarChart",
    },
  },
  // Rang 12 — Chord (disabled — requires ECharts >= 6.0.0, current: 5.4.3)
  chordChart: {
