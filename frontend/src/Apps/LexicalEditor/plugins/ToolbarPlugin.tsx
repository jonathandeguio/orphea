...
import { LexicalToolbarType, TToolbarPlugin } from "../LexicalEditor.types";
...
export function FloatingLinkEditor({ editor }: any) {
...
export default function ToolbarPlugin({ type }: TToolbarPlugin) {
  ...
  function FillURL() {
    const srcfile = prompt("Enter the resource Id of the image:", "");
    return srcfile;
  }
  ...
  return (
    <div className="toolbar" ref={toolbarRef}>
      {type == LexicalToolbarType.HEADER && (
        <>
          <button
            disabled={!canUndo}
            onClick={() => {
