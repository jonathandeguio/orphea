      ...
      >
        ...
        <g stroke-width="1">
          <g>
            <path
              clip-rule="evenodd"
              d="M2 12.417c0 .452.216.863.56 1.15.342.284.79.433 1.24.433h8.4c.45 0 .898-.149 1.24-.433a1.5 1.5 0 0 0 .56-1.15V9h-1v3.417a.503.503 0 0 1-.2.382.944.944 0 0 1-.6.201H3.8a.944.944 0 0 1-.6-.201.503.503 0 0 1-.2-.382V3.583c0-.122.058-.262.2-.382A.944.944 0 0 1 3.8 3H7V2H3.8c-.45 0-.898.148-1.24.433A1.5 1.5 0 0 0 2 3.583v8.834Z"
              fill="currentColor"
              fill-rule="evenodd"
            ></path>
            <path
              clip-rule="evenodd"
              d="M14 2H9v1h3.293L7.646 7.646l.708.708L13 3.707V7h1V2Z"
              fill="currentColor"
              fill-rule="evenodd"
            ></path>
          </g>
...
function ExcelIcon({ size = 16, color = "#217346", style }: TBoslerIconProps) {
  return (
    <div className="bosler-icons" style={style}>
      <svg
        color={color}
        ...
        width={size}
      >
        <desc>Excel file icon</desc>
        <path d="M6 2C4.895 2 4 2.895 4 4v16c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2V8.414L14.586 2H6zm0 2h7v4h4v12H6V4zm9 7h-1.5L12 15.25 10.5 11H9l2.5 7h1l2.5-7z"></path>
      </svg>
    </div>
  );
}

function WordIcon({ size = 16, color = "#2B579A", style }: TBoslerIconProps) {
  return (
    <div className="bosler-icons" style={style}>
      <svg
        color={color}
        ...
        width={size}
      >
        <desc>Word file icon</desc>
        <path d="M6 2C4.895 2 4 2.895 4 4v16c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2V8.414L14.586 2H6zm0 2h7v4h4v12H6V4zm3 7h1l1 4 1-4h1l1 4 1-4h1l-1.5 6h-1l-1-4-1 4h-1L9 11z"></path>
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="bosler-icons" style={style}>
      <svg
        ...
        width={size}
      >
        <desc>PowerPoint file icon</desc>
        <path d="M6 2C4.895 2 4 2.895 4 4v16c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2V8.414L14.586 2H6zm0 2h7v4h4v12H6V4zm9 5c.552 0 1 .448 1 1v6c0 .552-.448 1-1 1h-6c-.552 0-1-.448-1-1v-1H7v-2h1v-1H7v-2h1v-1c0-.552.448-1 1-1h6zm-1 5h-1v1h1v-1zm0-2h-1v1h1v-1zm-2 0h-1v1h1v-1zm0 2h-1v1h1v-1z"></path>
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="bosler-icons" style={style}>
      <svg
        ...
        width={size}
      >
        <desc>Outlook file icon</desc>
        <path d="M6 2C4.895 2 4 2.895 4 4v16c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2V8.414L14.586 2H6zm0 2h7v4h4v12H6V4zm7 5v1H9v1h4v1H9v1h4v1H9v1h4v1H9v1h4v1H9v1h4v1h-4v-1H7v-1h4v-1H7v-1h4v-1H7v-1h4v-1H7v-1h4v-1H7v-1h4v-1H7V9h6z"></path>
      </svg>
    </div>
  );
}

function OneNoteIcon({
  size = 16,
  color = "#7719AA",
  style,
}: TBoslerIconProps) {
  return (
    <div className="bosler-icons" style={style}>
      <svg
        ...
        width={size}
      >
        <desc>OneNote file icon</desc>
        <path d="M6 2C4.895 2 4 2.895 4 4v16c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2V8.414L14.586 2H6zm0 2h7v4h4v12H6V4zm7 7v7h-1l-2-2v2H9v-7h1v4l2-2v2h1v-7h-2V9h3v2h-2v1h2z"></path>
      </svg>
    </div>
  );
}

function AccessIcon({ size = 16, color = "#A4373A", style }: TBoslerIconProps) {
  return (
    <div className="bosler-icons" style={style}>
      <svg
        color={color}
        ...
        width={size}
      >
        <desc>Access file icon</desc>
        <path d="M6 2C4.895 2 4 2.895 4 4v16c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2V8.414L14.586 2H6zm0 2h7v4h4v12H6V4zm9 6H9v8h6v-8zm-2 1h1v1h-1v1h-1v-1h-1v-1h1v-1h1v1z"></path>
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="bosler-icons" style={style}>
      <svg
        ...
        width={size}
      >
        <desc>Publisher file icon</desc>
        <path d="M6 2C4.895 2 4 2.895 4 4v16c0 1.105.895 2 2 2h12c1.105 0 2-.895 2-2V8.414L14.586 2H6zm0 2h7v4h4v12H6V4zm9 7h-1v1h1v1h-1v1h-1v-1h-1v-1h1v-1h1v-1h-2V9h3v2z"></path>
      </svg>
    </div>
  );
}
