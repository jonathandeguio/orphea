...
export const agentDeleteReducer = (
  state: $TSFixMe = { agent: [] },
  action: $TSFixMe
) => {
  switch (action.type) {
...
export const agentCreateReducer = (state = {}, action: $TSFixMe) => {
  switch (action.type) {
...
export const agentLinksListReducer = (
  state: $TSFixMe = { agentLinks: [] },
  action: $TSFixMe
) => {
  switch (action.type) {
