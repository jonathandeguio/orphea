...
Les tableaux de bord sont un moyen d'afficher une gamme de graphiques et de données directement dans Orphea.
Les tableaux de bord utilisent une solution de glisser-déposer pour ajouter et modifier différents graphiques et vues.

![dash1](../../../../../docs/_media/docs_ss/analyze/dashboard.png)
