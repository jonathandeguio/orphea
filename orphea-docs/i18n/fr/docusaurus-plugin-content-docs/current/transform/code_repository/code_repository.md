...
- Les référentiels de fonctions sont destinés à écrire une logique métier pouvant être exécutée rapidement dans un cadre opérationnel. Ils sont livrés avec une prise en charge intégrée pour accéder aux données de l'ontologie Orphea et incluent la saisie semi-automatique PySpark basée sur les types de données Ontology.
