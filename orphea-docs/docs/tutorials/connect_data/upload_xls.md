...
<subheader>Learn simple methods to get your data into Orphea by uploading files and setting up data connections</subheader>

<hr/>
There are two primary ways to get your data into a Orphea project:
