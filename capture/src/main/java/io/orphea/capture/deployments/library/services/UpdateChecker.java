package io.orphea.capture.deployments.library.services;
    ...
    public void checkUpdates() {
        ...
        try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
            ...
            try (CloseableHttpResponse response = httpClient.execute(request)) {
                ...
                Set<String> componentsToCompare = Set.of("frontend", "boson", "julia", "callisto", "capture", "orpheaDocs", "sparkHistoryServer", "globalVersion");
