...
//import io.orphea.capture.logger.library.services.LoggerService;
...
//@Transactional
//public class SystemDiskMetricLogsService {
//    private static final String LOG_FILE_PATH = "logs/boson/metrics/disk/disk_metrics.log";
//    private static final String MARKER_FILE_DIR = "logs/boson/metrics/disk/";
//
//    @Value("${log.api.metric.diskMetricsEndpoint}")
//    private String logApiEndpoint;
//
//    private static final String METRIC_TYPE = "boson.metric.disk";
//
//    @Autowired
...
//        logBatch.sort(this::compareBosonMetricsModel);
//
...
//    }
//
//    private int compareBosonMetricsModel(Object o1, Object o2) {
