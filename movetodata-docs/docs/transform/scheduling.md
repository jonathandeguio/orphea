...
Scheduling and Builds are linked together. You can set triggers to schedules builds of datasets in MoveToData

## Creating a schedule

In any datasets, there is a schedule option below.

![Schedule1](../_media/old_doc_ss/Schedule/schedule1.1.png)
...
You are able to customise the schedule trigger down to the second giving you all options to ensure you can use MoveToData to your liking.

![Schedule2](../_media/old_doc_ss/Schedule/schedule2.png)

You can customize either by time or by source.

![Schedule3](../_media/old_doc_ss/Schedule/schedule3.png)

To check your schedules table, click on the schedules on the sidebar menu.

![Schedule4](../_media/old_doc_ss/Schedule/schedule4.png)
