...
MoveToData allows administrators to manage users in MoveToData on one page.

![Users Splash](../_media/docs_ss/Security/token/userPageContent.png)

In this page located under MoveToData settings, it is simple to quickly see all users in the MoveToData environment and key details such as:
...
Creating a user in MoveToData is a simple process.
