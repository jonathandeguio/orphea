...
Sur la page d'accueil de MoveToData, vous pouvez visualiser les pipelines d'ensembles de données. Cliquez simplement sur les pipelines qui vous dirigeront vers la page Bézier.
