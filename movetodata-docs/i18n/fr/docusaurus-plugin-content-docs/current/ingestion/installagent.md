...
Le logiciel d'agent de collecte de données de MoveToData s'appelle Ignite.
...
![ds1](../../../../../docs/_media/docs_ss/Ingestion/Installagent/CreateAgent.PNG)

- Sous l'onglet Agents, sélectionnez l'option "Nouvel agent" dans le coin supérieur droit

![ia2](../../../../../docs/_media/docs_ss/Ingestion/Installagent/CreateNewAgent.PNG)
