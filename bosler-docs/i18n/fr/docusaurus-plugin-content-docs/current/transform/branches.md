...
En général, les branches Bosler permettent aux développeurs de travailler indépendamment sur différentes parties d'une base de code, de collaborer sur des fonctionnalités et des corrections de bugs, et de suivre les modifications apportées à la base de code au fil du temps.

Voici une brève explication d'une branche :

Branche principale: La branche master est la branche principale du référentiel Bosler. Elle contient généralement la dernière version stable de la base de code.
...
Par défaut, Bosler vous montrera la branche principale.
...
- Bosler vous demandera de confirmer le nom de la branche que vous souhaitez supprimer.
