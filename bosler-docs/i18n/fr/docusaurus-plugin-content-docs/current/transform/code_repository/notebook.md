...
Le notebook constitue un élément essentiel des flux de travail en science des données. Au sein de Bosler, nous avons intégré de manière transparente la fonctionnalité de notebook dans notre infrastructure de dépôt de code.
...
Vous devez utiliser certaines des fonctions internes de Bosler pour accéder aux ensembles de données.

Voici un exemple de cellule :

```python

from bosler.notebook import ReadDataFrame
