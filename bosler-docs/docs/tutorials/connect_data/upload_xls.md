...
<subheader>Learn simple methods to get your data into Bosler by uploading files and setting up data connections</subheader>

<hr/>
There are two primary ways to get your data into a Bosler project:
