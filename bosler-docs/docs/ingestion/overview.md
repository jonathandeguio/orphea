...
This documentation will guide you through the process of establishing a connection between your organization's data and the Bosler platform for the first time.
...
![Bosler Network](../_media/old_doc_ss/Boslerdiagram/boslerdiagram.jpg)
...
:::tip
A single Data Source can support multiple Links. For exmaple, you can link multiple postgres table to bosler or multiple csv files from a folder.
:::
