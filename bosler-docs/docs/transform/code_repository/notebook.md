...
The notebook constitutes an integral component of data science workflows. Within Bosler, we've seamlessly integrated the notebook functionality into our code repository infrastructure.
...
You have to use some of the internal bosler functions to access the datasets.
